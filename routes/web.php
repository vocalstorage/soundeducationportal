...
Route::prefix('admin')->group(function () {
    ...
    //Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::prefix('lesson')->group(function () {
            ...
            Route::get('/show', 'admin\AdminLessonController@show');
            Route::get('/edit/{id}', 'admin\AdminLessonController@edit')->name('admin-lesson-edit');
            Route::post('/update', 'admin\AdminLessonController@update')->name('admin-lesson-update');
            Route::get('/delete/{id}', 'admin\AdminLessonController@delete')->name('admin-lesson-delete');
        });

        Route::prefix('lesson_date')->group(function () {
            Route::get('/create/{id}', 'admin\AdminLessonDateController@create')->name('admin-lesson_date-create');
            Route::post('/store', 'admin\AdminLessonDateController@store');
            Route::post('/edit', 'admin\AdminLessonDateController@edit');
            Route::post('/update', 'admin\AdminLessonDateController@update');
            Route::get('/delete/{id}', 'admin\AdminLessonDateController@delete');
    ...
    Route::prefix('student')->group(function () {
        ...
        Route::prefix('teacher')->group(function () {
            ...
            Route::get('/destroy', 'admin\AdminTeacherController@destroy')->name('admin-teacher-delete');
