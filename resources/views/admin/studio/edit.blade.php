...
@section('content')
    ...
    <form action="{{route('admin-studio-update',$studio->id)}})}}" onsubmit="return validateForm('Editing studio')" method="post">
        {{csrf_field()}}
        ...
        <input id="description_value" type="hidden" name="description" value="{{$studio->description}}">
        <div class="row">
