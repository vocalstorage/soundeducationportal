$(document).ready(function () {
    ...
    $("body").on("click", ".lesson_date_delete", function () {
        swal({
            ...
            tr.fadeOut("fast", function () {
                ...
                if($('.entr').length > 0){
                    console.log(lesson_dates.length );
    ...
    $("body").on("click", "span", function () {
        ...
        if ($("#btnAddDate").length == 0 && $("#form-lesson_date_update").css('display') == 'none') {
            html = '<div class="form-group">\n' +
                '                    <button type="button" class="btn waves-effect waves-light green lighten-1" id="btnAddDate" style="display: none">Voeg datum toe</button>\n' +
                '                </div>';
    ...
    $("body").on("click", "#btnAddDate", function () {
        ...
        if($("#deadlineNr").val() > 0 && $("#deadlineNr").val() < 21){
            ...
            if ($("#btnMakeLesson").length == 0) {
                $("#lesson_header_function").append('<button class="btn float-right green lighten-1" id="btnMakeLesson">Maak les aan</button>');
            } else {
    ...
    $("body").on("click", "#btnAddDateUpdate", function () {
        ...
        lesson_dates[lesson_date_index].deadline = $('#deadlineNr').val();
    ...
    $(" body").on("click", ".lesson_date_create_edit", function () {
        ...
        $('#deadlineNr').val(lesson_date.deadline);
